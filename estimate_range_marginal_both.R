...
adpfname = "../AgroServYield_coefficients/Resulting_tables/Feb7/AD.csv" # Adapt coef values
agtfname = "../AgroServYield_coefficients/Resulting_tables/Feb7/agroservT.csv" # AgroservT coefficient values
betfname = "../AgroServYield_coefficients/Resulting_tables/Feb7/Betas.csv" #Moore's betas
...
# # Moore stuff
# adpdata <- read.csv(adpfname) %>% filter(MngSystem == "HI") 
# agtdata <- read.csv(agtfname)
...
# 
# alldata left_join(betdata, by = c("Crop")) %>%
